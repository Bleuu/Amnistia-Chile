        ...
        <div class="main">
            <section class="list_result">
                <article>
                    <div class="img_article">
                        <a href="article.php" title="" >
                            <img src="assets/haiti-nacionalidad.jpg" alt="" />
                        </a>
                    </div>
                    <div class="resume_article result_list">
                        <p class="title_article"><a href="article.php" title="" >Cuatro testimonios a 10 años del Informe Final de la CVR</a></p>
                        <p class="info_article">31, Oct. 2013 | Categoria: <a href="" title="" >Desapariciones forzadas</a> | <a href="" title="" >1 Comentarios</a></p>
                        <p class="description_secondary">A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.</p>
                        <a href="article.php" title="" class="btn btn_sec">Ver más <span class="icon_btn plus"></span></a>
                    </div>
                </article>  
                <article>
                    <div class="img_article">
                ...
                <article>
                    ...
                    <div class="resume_article result_list">
                        <p class="title_article"><a href="article.php">Cuatro testimonios a 10 años del Informe Final de la CVR</a></p>
                        <p class="info_article">31, Oct. 2013 | Categoria: <a href="" title="" >Desapariciones forzadas</a> | <a href="" title="" >1 Comentarios</a></p>
                        <p class="description_secondary">A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.A una década de la publicación del Informe Final de la Comisión.</p>
                        <a href="article.php" title="" class="btn btn_sec">Ver más <span class="icon_btn plus"></span></a>
                    </div>
            ...
            <ul class="page_ctrl">
                ...
                <li><a href="" title="siguiente página">Siguiente &raquo;</a></li>
            </ul><!--page_ctrl-->
        </div><!--main-->
        <aside>
            <div class="sidebar_box fullphoto">
                ...
                <div class="content_fp">
                    <p class="title_fp">
                        <span>Llevamos</span>
                        <span class="big">6.218</span>
                        <span>firmas este año</span>
                    </p>
                    <div class="text_fp">
                        <div class="vertical_content">Puede ser:</div>
                        <ul class="with_vertical">
                            <li><a href="" title="" >Conócenos</a></li>
                            <li><a href="" title="" >Amnistía en Perú</a></li>
                            <li><a href="" title="" >Nuestros principios</a></li>
                            <li><a href="" title="" >Amnistía es transparencia</a></li>
                            <li><a href="" title="" >Cómo nos organizamos</a></li>
                            <li><a href="" title="" >Orígenes del movimiento</a></li>
            ...
            <div class="sidebar_box quick_donate">
                ...
                <div class="line">
                    <input type="text" class="input_donate" placeholder="ej: 1.000" >
                    <div class="btn btn_sec big_icon">DONAR<span class="icon_donar"></span></div>
                </div>
                <p class="text_donate">Dona lo que puedas. Prometemos usar ese dinero en nuestras compañas</p>
                <div class="donate_webpay">
                    <a href="https://www.webpay.cl/portalpagodirecto/pages/institución.jsf?idEstablecimiento=1934788" title="" target="_blank">
                        <img src="assets/webpay.png" alt="" >
                    </a>
                </div>
            </div>
