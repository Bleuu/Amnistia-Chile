        ...
        <div class="main">
            ...
            <div class="showbox">
                <div class="insb_left">
                    <ul class="sb_labels">
                    <?php
                        query_posts(array('post_type'=>'actua-amnistia','showposts'=>-1,'order'=>DSC));
                ...
                <div class="insb_right">
                    ...
                    <?php
                        ...
                        if(have_posts()) : while(have_posts()) : the_post();
                        $urlup = types_render_field("introducir-url", array("id"=>"","output"=>"raw",""=>""));
                        $urlti = types_render_field("titulo-link", array(""=>"",""=>"",""=>""));
                    ?>
