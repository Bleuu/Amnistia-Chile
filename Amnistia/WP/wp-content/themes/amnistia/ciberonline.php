    ...
    <div class="wrap">
        <div class="main">
            <div class="breadcrumb">
                <a href="<?php bloginfo('url'); ?>">Inicio</a> &#9658; <a href="<?php bloginfo('url'); ?>/actua/acciones-online/">Acciones Urgentes</a> &#9658; Listado
            </div>
            <div class="content_box wysiwyg">
                ...
                <div class="accion_list">
                    <ul>
                        <?php
    $get_onlineacciones = new WP_query(array(
        'post_type'=>'acciononline', 
        'posts_per_page' => 6, 
        'paged'=>get_query_var('paged')
    ));

if ($get_onlineacciones->have_posts()):
$i=0;
while($get_onlineacciones->have_posts()) : $get_onlineacciones->the_post();
$i++;
...
endwhile;
                ...
                <?php pagination($get_onlineacciones); ?>            
            </div>
        </div><!--main-->
        <aside>
            <?php get_sidebar(); ?>
