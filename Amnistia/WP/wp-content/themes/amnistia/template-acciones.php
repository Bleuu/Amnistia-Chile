    ...
    <div class="wrap">
        <div class="main">
            ...
            <div class="breadcrumb">
                <a href="<?php bloginfo('url'); ?>">Inicio</a> &#9658; <a href="<?php bloginfo('url'); ?>/actua">Actua</a> &#9658; <a href="<?php echo get_the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a>
            </div>
                ...
                <div class="accion_list">
                    <ul>
                       <?php
                            ...
                            if ($post_name=='acciones-urgentes'){
                                $post_name = 'accion';
                            }else if ($post_name=='acciones-online'){
                                $post_name = 'acciononline';
                            }
